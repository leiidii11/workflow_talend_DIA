---
name: talend-dia-workflow
description: "WORKFLOW SKILL — Utiliser pour orchestrer la creation DIA Talend + Snowflake avec mode exclusif TABLE_ONLY ou SEQUENCE_ONLY, generation DDL/DML, fichiers XML Talend, et mise a jour Git sans commit/push. Mots-cles: talend, snowflake, DIA, DDL, DML, sequence, table, xml, sharepoint"
user-invocable: true
---

# Skill Technique: Workflow Talend DIA
